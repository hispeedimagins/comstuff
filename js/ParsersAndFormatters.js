...
function formatDecimal(value, decPlaces = 2, truncate0s = true) {
...
function translateError(string) {
    ...
    switch (string) {
        case 'Account not found':
            return ('g.account_not_found');
        case 'Incorrect Password':
            return ('g.incorrect_password');
        case 'Username does not exist':
            return ('g.username_does_not_exist');
        case 'Account name should be longer.':
            return ('g.account_name_should_be_longer');
        case 'Account name should be shorter.':
            return ('g.account_name_should_be_shorter');
        case 'Account name should start with a letter.':
            return ('g.account_name_should_start_with_a_letter');
